...
public class CardList : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        list.Add(new Card(20, "d9", 5, 6, 8, "normalDevil", Resources.Load<Sprite>("1"), 0));
        list.Add(new Card(21, "d10", 5, 6, 8, "attackDevil", Resources.Load<Sprite>("1"), 1));
        list.Add(new Card(22, "d11", 5, 6, 8, "defenseDevil", Resources.Load<Sprite>("1"), 2));
        list.Add(new Card(23, "d12", 5, 6, 8, "spikeDevil", Resources.Load<Sprite>("1"), 3));
